...
Currently, HerbieATX only responds to one keyword adapted to the American English (`en-US`) language. To add more keyword options or expand on the keyword table so that speech detection is more accurate, refer to this resource:  
